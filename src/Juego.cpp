...
Juego::Juego()
    ...
    if (!backTexture.loadFromFile("../sprites/fondo.jpg") ||
        !dinoTexture.loadFromFile("../sprites/spriten.png") ||
        !dino2Texture.loadFromFile("../sprites/image.png") ||
        !plataforma1Texture.loadFromFile("../sprites/plataforma_1.png") ||
        !plataforma2Texture.loadFromFile("../sprites/plataforma_2.png") ||
        !plataforma3Texture.loadFromFile("../sprites/plataforma_3.png") ||
        !trampaTexture.loadFromFile("../sprites/trampa.png") ||
        !dinamitaTexture.loadFromFile("../sprites/dinamita.png") ||
        !inicioTexture.loadFromFile("../sprites/inicio.png") ||
        !metaTexture.loadFromFile("../sprites/meta.png")) {
